...
function createAuthConfig(envPrefix = 'MS_') {
  ...
  return {
    ...
    scopes: (process.env[`${envPrefix}SCOPES`] || 'offline_access User.Read Mail.Read Mail.ReadWrite Mail.Send Calendars.Read Calendars.ReadWrite Files.Read Files.ReadWrite').split(' '),
    tenantId,
